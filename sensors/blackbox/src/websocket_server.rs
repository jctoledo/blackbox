...
<body>
<div class="hdr"><div class="logo">BLACKBOX <span style="font-size:9px;color:#333">v4</span></div><div class="hdr-r"><a href="/autotune" style="color:#60a5fa;text-decoration:none;font-size:10px;margin-right:12px">⚙ Tune</a><span class="timer" id="timer">00:00</span><div class="st"><span class="dot" id="dot"></span><span id="stxt">--</span></div></div></div>
<div class="main">
...
impl TelemetryServer {
    ...
    pub fn new(port: u16) -> Result<Self, Box<dyn std::error::Error>> {
        ...
        let server_config = Configuration {
            http_port: port,
            max_uri_handlers: 8, /* Dashboard, autotune, telemetry, status, calibrate,
